  ...
  return (
    <div className="styled-container">
      ...
      <div className="styled-wrapper p-[50px] flex">
        ...
        <div className="info-container flex-[1] px-[50px] ">
          ...
          <div className="add-container flex items-center justify-between mt-4">
            <div className="amount-container flex items-center font-bold">
              ...
              <span className="amount w-[30px] h-[30px] border border-red-500 flex items-center justify-center mx-[5px]">
                1
              </span>
            ...
            <button className="p-[15px] border  hover:text-white cursor-pointer hover:shadow-md font-medium hover:bg-black">
              ADD TO CART &nbsp;
              <AddShoppingCartIcon />
            </button>
          </div>
          <div className="mt-[30px]">
            <h1 className="title text-[20px] font-bold mt-2">
              Read Chapters Online
            </h1>
            <hr />

            <div>
              <p className="my-[20px] flex items-center justify-between hover:font-extrabold">
                Chapter 1{" "}
                <DownloadIcon className="hover:bg-black hover:text-white rounded-full" />
              </p>
              <hr />
            </div>
